...
class UpdateCatToPostTest extends TestCase
{
  use WithFaker, DatabaseTransactions, WithoutMiddleware;
     ...
     * @return void
     */
    public function testUpdateCatToPost()
    {
      ...
      $attributes = [
        ...
        $this->json('POST','api/categories/create',$attributes3);
        $this->assertDatabaseHas('categories',$attributes3);


        //Get Cat ID.
        $category2 = CategoryController::show($attributes3['name']);

        // Add it to the post payload.
        $attributes['category'] = $category2->id;
